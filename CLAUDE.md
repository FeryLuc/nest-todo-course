...
Ce repo contient 14 branches `concept/` — chacune isole un concept NestJS avec le strict minimum fonctionnel.
...
Chaque branche possède son propre `CLAUDE.md` détaillé.
